...
const columns = [
  ...
  { label: 'Destino', key: 'ID_ARPT_DEST_ORIG' },
  { label: 'STA', key: 'DT_STDA' },
  { label: 'ETD', key: 'DT_ETDA' },
  { label: 'ATD', key: 'DT_ATDA' },
  { label: 'Remark', key: 'ID_REMARK' },
  { label: 'Terminal', key: 'TERMINAL' },
  { label: 'Sector', key: 'SECTOR' },
  { label: 'Checkins', key: 'CHECKINS' },
        ...
        <TableBody>
          {sortedItems.map((vuelo) => (
            <TableRow key={vuelo.id}>
              ...
              <TableCell style={cellStyle}>{vuelo.CHECKINS}</TableCell>
              <TableCell style={cellStyle}>{vuelo.GATE}</TableCell>
